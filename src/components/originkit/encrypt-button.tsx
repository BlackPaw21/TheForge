...
//   paddingY: 22
//   rounded: 25
//   sweepOptions: {"color":"#890000","count":2,"speed":7,"width":5}
//   border: true
//   borderOptions: {"color":"#C80000","width":4}
//   transition: {"type":"tween","duration":2.4,"delay":0,"ease":[0.44,0,0.56,1]}
...
export default function EncryptButton(props: EncryptButtonProps) {
  ...
  const resolvedHoverFill = hoverFill ?? fill;
  ...
  return (
    <motion.div
      aria-label={label}
      initial={false}
      animate={{ backgroundColor: hover ? resolvedHoverFill : fill }}
      transition={hover ? transition : { duration: 0 }}
      onHoverStart={() => {
        setHover(true);
        startScramble();
      }}
